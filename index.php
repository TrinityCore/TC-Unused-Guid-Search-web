...
<div class="container">
    ...
    foreach($dbLinks as $name => $db) {
        ...
        echo "$name creature range starts at $creatureRange, gameobject at $gameObjectRange. Last applied update: $last<br>";
    }
    ...
    <a href="https://github.com/ShinDarth/TC-Unused-Guid-Search-web">
